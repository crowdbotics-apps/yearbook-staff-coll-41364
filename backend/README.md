...
## Project Structure
    ...
    ├── yearbook_staff_coll_41364  # Django project configurations
...
1. Clone this repo and `cd yearbook_staff_coll_41364`
...
2. Clone this repo and `cd yearbook_staff_coll_41364`
